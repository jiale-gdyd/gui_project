...
public:
    ...
    QT_DEPRECATED_VERSION_X_5_14("Use loadRelaxed") T load() const noexcept {
        return loadRelaxed();
    }

    QT_DEPRECATED_VERSION_X_5_14("Use storeRelaxed") void store(T newValue) noexcept {
    ...
    static Q_DECL_CONSTEXPR bool isReferenceCountingNative() noexcept {
        return Ops::isReferenceCountingNative();
    }

    static Q_DECL_CONSTEXPR bool isReferenceCountingWaitFree() noexcept {
    ...
    static Q_DECL_CONSTEXPR bool isTestAndSetNative() noexcept {
        return Ops::isTestAndSetNative();
    }

    static Q_DECL_CONSTEXPR bool isTestAndSetWaitFree() noexcept {
    ...
    static Q_DECL_CONSTEXPR bool isFetchAndStoreNative() noexcept {
        return Ops::isFetchAndStoreNative();
    }

    static Q_DECL_CONSTEXPR bool isFetchAndStoreWaitFree() noexcept {
    ...
    static Q_DECL_CONSTEXPR bool isFetchAndAddWaitFree() noexcept {
...
#if QT_DEPRECATED_SINCE(5, 14)
    QT_DEPRECATED_VERSION_X_5_14("Use loadRelaxed") Type load() const noexcept {
        return loadRelaxed();
    }

    QT_DEPRECATED_VERSION_X_5_14("Use storeRelaxed") void store(Type newValue) noexcept {
        storeRelaxed(newValue);
    }
#endif
