...
#include <rtsp/internal/OnDemandServerMediaSession.h>

namespace rtsp {
OnDemandServerMediaSession::OnDemandServerMediaSession(const char *streamName, const char *info, const char *description, bool isSSM, const char *miscSDPLines, StreamControl *streamControl)
...
OnDemandServerMediaSubsession::OnDemandServerMediaSubsession(char const *trackId, char const *sdp, char const *codec, unsigned char rtpPayloadType, unsigned timestampFrequency) 
