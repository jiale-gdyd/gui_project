#ifndef RTSP_SIMPLE_RTSP_SERVER_QUEUE_H
#define RTSP_SIMPLE_RTSP_SERVER_QUEUE_H
...
#define TAILQ_FOREACH_REVERSE(var, head, headname, field)                                       \
    for ((var) = (*(((struct headname *)((head)->tqh_last))->tqh_last)); (var); (var) = (*(((struct headname *)((var)->field.tqe_prev))->tqh_last)))
