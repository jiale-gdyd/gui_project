...
static void vpu1_h263d_setup_regs_by_syntax(hal_h263_ctx *ctx, MppSyntax syntax)
{
    Vpu1H263dRegSet_t *regs = (Vpu1H263dRegSet_t*)ctx->regs;
    ...
    regs->SwReg03.sw_dec_mode = 2;
    regs->SwReg03.sw_filtering_dis = 1;
    regs->SwReg18.sw_h263_vc1_rc = 0;
    ...
    regs->SwReg18.sw_prev_anc_type = (pp->prev_coding_type == H263_P_VOP);
}
...
MPP_RET hal_vpu1_h263d_gen_regs(void *hal,  HalTaskInfo *syn)
{
    ...
    memset(regs, 0, sizeof(Vpu1H263dRegSet_t));
    ...
    vpu1_h263d_setup_regs_by_syntax(ctx, task->syntax);
