...
int nouveau_object_mthd(struct nouveau_object *, uint32_t mthd, void *data, uint32_t size);
int nouveau_object_sclass_get(struct nouveau_object *, struct nouveau_sclass **);
...
int nouveau_device_new(struct nouveau_object *parent, int32_t oclass, void *data, uint32_t size, struct nouveau_device **);
...
int nouveau_bo_name_ref(struct nouveau_device *v, uint32_t name, struct nouveau_bo **);
...
struct nouveau_bufref *nouveau_bufctx_refn(struct nouveau_bufctx *, int bin, struct nouveau_bo *, uint32_t flags);
struct nouveau_bufref *nouveau_bufctx_mthd(struct nouveau_bufctx *, int bin,  uint32_t packet, struct nouveau_bo *, uint64_t data, uint32_t flags, uint32_t vor, uint32_t tor);
...
int nouveau_pushbuf_new(struct nouveau_client *, struct nouveau_object *chan, int nr, uint32_t size, bool immediate, struct nouveau_pushbuf **);
...
bool nouveau_check_dead_channel(struct nouveau_drm *, struct nouveau_object *chan);
