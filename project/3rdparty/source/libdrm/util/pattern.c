...
#include <libdrm/util/format.h>
#include <libdrm/util/pattern.h>
...
#define MAKE_YUV_601(r, g, b)               { .y = MAKE_YUV_601_Y(r, g, b), .u = MAKE_YUV_601_U(r, g, b), .v = MAKE_YUV_601_V(r, g, b) }
...
#define MAKE_RGBA10(rgb, r, g, b, a)        (shiftcolor10(&(rgb)->red, (r)) | shiftcolor10(&(rgb)->green, (g)) | shiftcolor10(&(rgb)->blue, (b)) | shiftcolor10(&(rgb)->alpha, (a)))
#define MAKE_RGBA(rgb, r, g, b, a)          (shiftcolor8(&(rgb)->red, (r)) | shiftcolor8(&(rgb)->green, (g)) | shiftcolor8(&(rgb)->blue, (b)) | shiftcolor8(&(rgb)->alpha, (a)))
...
static void fill_smpte_yuv_planar(const struct util_yuv_info *yuv, unsigned char *y_mem, unsigned char *u_mem, unsigned char *v_mem, unsigned int width, unsigned int height, unsigned int stride)
{
...
static void fill_smpte_yuv_packed(const struct util_yuv_info *yuv, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    const struct color_yuv colors_top[] = {
        MAKE_YUV_601(191, 192, 192),            /* grey */
        MAKE_YUV_601(192, 192, 0),              /* yellow */
...
static void fill_smpte_rgb16(const struct util_rgb_info *rgb, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    ...
    for (; y < height; ++y) {
        ...
        for (; x < width * 6 / 7; ++x) {
            ((uint16_t *)mem)[x] = colors_bottom[(x - width * 5 / 7) * 3 / (width / 7) + 4];
        }
...
static void fill_smpte_rgb24(const struct util_rgb_info *rgb, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
...
static void fill_smpte_rgb32(const struct util_rgb_info *rgb, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
...
static void fill_smpte_rgb16fp(const struct util_rgb_info *rgb, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    ...
    for (; y < height; ++y) {
        ...
        for (; x < width * 6 / 7; ++x) {
            ((uint64_t *)mem)[x] = colors_bottom[(x - width * 5 / 7) * 3 / (width / 7) + 4];
        }
...
static void fill_smpte(const struct util_format_info *info, void *planes[3], unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned char *u, *v;
...
static void fill_tiles_yuv_planar(const struct util_format_info *info, unsigned char *y_mem, unsigned char *u_mem, unsigned char *v_mem, unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned int x;
    unsigned int y;
...
static void fill_tiles_yuv_packed(const struct util_format_info *info, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned int x;
    unsigned int y;
    const struct util_yuv_info *yuv = &info->yuv;
...
static void fill_tiles_rgb16(const struct util_format_info *info, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned int x, y;
    void *mem_base = mem;
...
static void fill_tiles_rgb24(const struct util_format_info *info, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned int x, y;
    const struct util_rgb_info *rgb = &info->rgb;
...
static void fill_tiles_rgb32(const struct util_format_info *info, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned int x, y;
    void *mem_base = mem;
    const struct util_rgb_info *rgb = &info->rgb;
...
static void fill_tiles_rgb16fp(const struct util_format_info *info, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned int x, y;
    const struct util_rgb_info *rgb = &info->rgb;
...
static void fill_tiles(const struct util_format_info *info, void *planes[3], unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned char *u, *v;
...
static void fill_gradient_rgb32(const struct util_rgb_info *rgb, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned int i, j;
...
static void fill_gradient_rgb16fp(const struct util_rgb_info *rgb, void *mem, unsigned int width, unsigned int height, unsigned int stride)
{
    unsigned int i, j;
...
static void fill_gradient(const struct util_format_info *info, void *planes[3], unsigned int width, unsigned int height, unsigned int stride)
{
    switch (info->format) {
        case DRM_FORMAT_ARGB8888:
        case DRM_FORMAT_XRGB8888:
