                                                     ...
                                                     const lv_point_t * pos, lv_font_glyph_dsc_t * g, const uint8_t * map_p)
{
    ...
    lv_opa_t * mask_buf = (lv_opa_t *)lv_malloc(mask_buf_size);
                              ...
                              lv_font_glyph_dsc_t * g, const uint8_t * map_p)
{
    ...
    lv_color_t * color_buf = (lv_color_t *)lv_malloc(mask_buf_size * sizeof(lv_color_t));

    int32_t dest_buf_stride = lv_area_get_width(draw_ctx->buf_area);
    lv_color_t * dest_buf_tmp = (lv_color_t *)draw_ctx->buf;
