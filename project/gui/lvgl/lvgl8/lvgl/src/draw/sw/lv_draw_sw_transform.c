        ...
        if(draw_dsc->antialias == 0) {
            switch(cf) {
                case LV_IMG_CF_TRUE_COLOR_ALPHA:
                    argb_no_aa((const uint8_t *)src_buf, src_w, src_h, src_stride, xs_ups, ys_ups, xs_step_256, ys_step_256, dest_w, cbuf, abuf);
                    break;
                case LV_IMG_CF_TRUE_COLOR:
                case LV_IMG_CF_TRUE_COLOR_CHROMA_KEYED:
                    rgb_no_aa((const uint8_t *)src_buf, src_w, src_h, src_stride, xs_ups, ys_ups, xs_step_256, ys_step_256, dest_w, cbuf, abuf, cf);
                    break;
#if LV_COLOR_DEPTH == 16
                case LV_IMG_CF_RGB565A8:
                    rgb565a8_no_aa((const uint8_t *)src_buf, src_w, src_h, src_stride, xs_ups, ys_ups, xs_step_256, ys_step_256, dest_w, cbuf, abuf);
                    break;
#endif          
                default:
                    break;
            ...
            switch(cf) {
                case LV_IMG_CF_ALPHA_8BIT:
                    a8_aa((const uint8_t *)src_buf, src_w, src_h, src_stride, xs_ups, ys_ups, xs_step_256, ys_step_256, dest_w, abuf);
                    break;
                default:
                    argb_and_rgb_aa((const uint8_t *)src_buf, src_w, src_h, src_stride, xs_ups, ys_ups, xs_step_256, ys_step_256, dest_w, cbuf, abuf, cf);
                    break;
            }
        }
