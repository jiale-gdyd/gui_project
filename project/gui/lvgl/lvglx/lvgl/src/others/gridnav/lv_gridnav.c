...
void lv_gridnav_add(lv_obj_t * obj, lv_gridnav_ctrl_t ctrl)
{
    ...
    lv_gridnav_dsc_t * dsc = (lv_gridnav_dsc_t *)lv_malloc(sizeof(lv_gridnav_dsc_t));
...
{
    lv_gridnav_dsc_t * dsc = (lv_gridnav_dsc_t *)lv_obj_get_event_user_data(obj, gridnav_event_cb);
...
void lv_gridnav_set_focused(lv_obj_t * cont, lv_obj_t * to_focus, lv_anim_enable_t anim_en)
{
    ...
    lv_gridnav_dsc_t * dsc = (lv_gridnav_dsc_t *)lv_obj_get_event_user_data(cont, gridnav_event_cb);
    if(dsc == NULL) {
...
static void gridnav_event_cb(lv_event_t * e)
{
    ...
    lv_gridnav_dsc_t * dsc = (lv_gridnav_dsc_t *)lv_event_get_user_data(e);
    ...
    if(code == LV_EVENT_KEY) {
        ...
        if(key == LV_KEY_RIGHT) {
               ...
               lv_obj_get_scroll_left(dsc->focused_obj) > 0) {
                ...
                if(guess == NULL) {
                    if(dsc->ctrl & LV_GRIDNAV_CTRL_ROLLOVER) {
                        ...
                        lv_group_focus_prev((lv_group_t *)lv_obj_get_group(obj));
                    }
                }
            }
        }
            ...
            if(lv_group_get_focused((const lv_group_t *)lv_obj_get_group(obj)) == obj) {
