...
lv_meter_scale_t * lv_meter_add_scale(lv_obj_t * obj)
{
    ...
    lv_meter_scale_t * scale = (lv_meter_scale_t *)_lv_ll_ins_head(&meter->scale_ll);
                                                ...
                                                lv_color_t color, int16_t r_mod)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    lv_meter_t * meter = (lv_meter_t *)obj;
    lv_meter_indicator_t * indic = (lv_meter_indicator_t *)_lv_ll_ins_head(&meter->indicator_ll);
...
static void draw_arcs(lv_obj_t * obj, lv_draw_ctx_t * draw_ctx, const lv_area_t * scale_area)
{
    ...
    for (indic = (lv_meter_indicator_t *)_lv_ll_get_tail(&meter->indicator_ll); indic != NULL; indic = (lv_meter_indicator_t *)_lv_ll_get_prev(&meter->indicator_ll, indic)) {
...
static void draw_ticks_and_labels(lv_obj_t * obj, lv_draw_ctx_t * draw_ctx, const lv_area_t * scale_area)
{
    ...
    for (scale = (lv_meter_scale_t *)_lv_ll_get_tail(&meter->scale_ll); scale != NULL; scale = (lv_meter_scale_t *)_lv_ll_get_prev(&meter->scale_ll, scale)) {
