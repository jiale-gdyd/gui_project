...
void lv_menu_refr(lv_obj_t * obj)
{
    ...
    /* The current menu */
    lv_menu_history_t * act_hist = (lv_menu_history_t *)_lv_ll_get_head(history_ll);
...
void lv_menu_set_page(lv_obj_t * obj, lv_obj_t * page)
{
    ...
    if(page != NULL) {
        /* Add a new node */
        lv_ll_t * history_ll = &(menu->history_ll);
        lv_menu_history_t * new_node = (lv_menu_history_t *)_lv_ll_ins_head(history_ll);
...
void lv_menu_set_load_page_event(lv_obj_t * menu, lv_obj_t * obj, lv_obj_t * page)
{
    ...
    lv_menu_load_page_event_data_t * event_data = (lv_menu_load_page_event_data_t *)lv_malloc(sizeof(lv_menu_load_page_event_data_t));
...
void lv_menu_set_page_title(lv_obj_t * page_obj, char const * const title)
{
    ...
    if(title) {
        page->title        = (char *)lv_malloc(strlen(title) + 1);
        page->static_title = false;
...
static void lv_menu_load_page_event_cb(lv_event_t * e)
{
    ...
    lv_menu_load_page_event_data_t * event_data = (lv_menu_load_page_event_data_t *)lv_event_get_user_data(e);
...
static void lv_menu_back_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_CLICKED) {
        ...
        /* The previous menu */
        lv_menu_history_t * prev_hist = (lv_menu_history_t *)_lv_ll_get_next(history_ll, act_hist);
