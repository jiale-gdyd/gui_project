...
static void lv_colorwheel_event(const lv_obj_class_t * class_p, lv_event_t * e)
{
    ...
    if(code == LV_EVENT_REFR_EXT_DRAW_SIZE) {
        ...
        *s = LV_MAX(*s, knob_pad);
        ...
        if(lv_obj_get_width(obj) != lv_area_get_width((const lv_area_t *)param) ||
           lv_obj_get_height(obj) != lv_area_get_height((const lv_area_t *)param)) {
            refr_knob_pos(obj);
        }
    }
        ...
        lv_hit_test_info_t * info = (lv_hit_test_info_t *)lv_event_get_param((lv_event_t *)e);;
        ...
        lv_cover_check_info_t * info = (lv_cover_check_info_t *)lv_event_get_param((lv_event_t *)e);
