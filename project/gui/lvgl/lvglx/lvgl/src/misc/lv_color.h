...
#define LV_OPA_MIN                      2     // 下面的不透明度将是透明的
#define LV_OPA_MAX                      253   // 高于此的不透明度将完全覆盖
...
#define LV_COLOR_MAKE32(r8, g8, b8)     {{b8, g8, r8, 0xff}}
...
typedef enum {
    LV_COLOR_FORMAT_NATIVE = 0,         // 保持原始格式。用于颜色对话
    LV_COLOR_FORMAT_NATIVE_REVERSE,     // 改变字节顺序
    ...
    LV_COLOR_FORMAT_CUSTOM_START = 0xff, // 可以从这里添加自定义格式
} lv_color_format_t;
