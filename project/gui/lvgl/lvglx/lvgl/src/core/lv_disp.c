...
void lv_disp_set_theme(lv_disp_t *disp, lv_theme_t *th)
{
    ...
    if ((disp->screen_cnt == 3) && (lv_obj_get_child_cnt(disp->screens[0]) == 0) && (lv_obj_get_child_cnt(disp->screens[1]) == 0) && (lv_obj_get_child_cnt(disp->screens[2]) == 0)) {
...
static void scr_load_anim_start(lv_anim_t *a)
{
    lv_disp_t *d = lv_obj_get_disp((const struct _lv_obj_t *)a->var);

    d->prev_scr = lv_scr_act();
    d->act_scr = (struct _lv_obj_t *)a->var;
...
static void set_x_anim(void *obj, int32_t v)
{
    lv_obj_set_x((struct _lv_obj_t *)obj, v);
}

static void set_y_anim(void *obj, int32_t v)
{
    lv_obj_set_y((struct _lv_obj_t *)obj, v);
}
...
static void scr_anim_ready(lv_anim_t *a)
{
    ...
    d->scr_to_load = NULL;
    lv_obj_remove_local_style_prop((struct _lv_obj_t *)a->var, LV_STYLE_OPA, 0);
