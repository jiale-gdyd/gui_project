...
void lv_fs_drv_register(lv_fs_drv_t * drv_p)
{
    /*Save the new driver*/
    lv_fs_drv_t * new_drv;
    new_drv = (lv_fs_drv_t *)_lv_ll_ins_head(&LV_GC_ROOT(_lv_drv_ll));
...
lv_fs_drv_t * lv_fs_get_drv(char letter)
{
    ...
    for (drv = (lv_fs_drv_t *)_lv_ll_get_head(&LV_GC_ROOT(_lv_drv_ll)); drv != NULL; drv = (lv_fs_drv_t *)_lv_ll_get_next(&LV_GC_ROOT(_lv_drv_ll), drv)) {
