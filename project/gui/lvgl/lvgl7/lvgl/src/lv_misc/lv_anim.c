...
void lv_anim_start(lv_anim_t * a)
{
    ...
    lv_anim_t * new_anim = (lv_anim_t *)_lv_ll_ins_head(&LV_GC_ROOT(_lv_anim_ll));
...
bool lv_anim_del(void * var, lv_anim_exec_xcb_t exec_cb)
{
    ...
    lv_anim_t * a_next;
    bool del = false;
    a        = (lv_anim_t *)_lv_ll_get_head(&LV_GC_ROOT(_lv_anim_ll));
    while(a != NULL) {
        /*'a' might be deleted, so get the next object while 'a' is valid*/
        a_next = (lv_anim_t *)_lv_ll_get_next(&LV_GC_ROOT(_lv_anim_ll), a);
...
lv_anim_t * lv_anim_get(void * var, lv_anim_exec_xcb_t exec_cb)
{
    ...
    for (a = (lv_anim_t *)_lv_ll_get_head(&LV_GC_ROOT(_lv_anim_ll)); a != NULL; a = (lv_anim_t *)_lv_ll_get_next(&LV_GC_ROOT(_lv_anim_ll), a)) {
...
static void anim_task(lv_task_t * param)
{
    ...
    lv_anim_t * a = (lv_anim_t *)_lv_ll_get_head(&LV_GC_ROOT(_lv_anim_ll));
    ...
    while(a != NULL) {
        ...
        if(anim_list_changed)
            ...
            a = (lv_anim_t *)_lv_ll_get_next(&LV_GC_ROOT(_lv_anim_ll), a);
    }
