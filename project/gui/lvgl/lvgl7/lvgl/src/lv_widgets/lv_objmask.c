...
lv_obj_t * lv_objmask_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_objmask_ext_t * ext = (lv_objmask_ext_t *)lv_obj_allocate_ext_attr(objmask, sizeof(lv_objmask_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
        lv_obj_del(objmask);
        return NULL;
...
lv_objmask_mask_t * lv_objmask_add_mask(lv_obj_t * objmask, void * param)
{
    ...
    lv_objmask_ext_t * ext = (lv_objmask_ext_t *)lv_obj_get_ext_attr(objmask);

    lv_draw_mask_common_dsc_t * dsc = (lv_draw_mask_common_dsc_t *)param;
    uint16_t param_size = get_param_size(dsc->type);

    lv_objmask_mask_t * m = (lv_objmask_mask_t *)_lv_ll_ins_head(&ext->mask_ll);
    LV_ASSERT_MEM(m);
...
void lv_objmask_remove_mask(lv_obj_t * objmask, lv_objmask_mask_t * mask)
{
    ...
    if(mask == NULL) {
        ...
        for (m = (lv_objmask_mask_t *)_lv_ll_get_head(&ext->mask_ll); m != NULL; m = (lv_objmask_mask_t *)_lv_ll_get_next(&ext->mask_ll, m)) {
            lv_mem_free(m->param);
        }
...
static lv_design_res_t lv_objmask_design(lv_obj_t * objmask, const lv_area_t * clip_area, lv_design_mode_t mode)
{
    ...
    /*Draw the object*/
        ...
        //_LV_LL_READ(ext->mask_ll, m) {
        for (m = (lv_objmask_mask_t *)_lv_ll_get_head(&ext->mask_ll); m != NULL; m = (lv_objmask_mask_t *)_lv_ll_get_next(&ext->mask_ll, m)) {
            lv_draw_mask_common_dsc_t * dsc = (lv_draw_mask_common_dsc_t *)m->param;

            if(dsc->type == LV_DRAW_MASK_TYPE_LINE) {
                lv_draw_mask_line_param_t * p_ori = (lv_draw_mask_line_param_t *)m->param;
                lv_draw_mask_line_param_t * p_new = (lv_draw_mask_line_param_t *)_lv_mem_buf_get(sizeof(lv_draw_mask_line_param_t));
                ...
                lv_draw_mask_angle_param_t * p_ori = (lv_draw_mask_angle_param_t *)m->param;
                lv_draw_mask_angle_param_t * p_new = (lv_draw_mask_angle_param_t *)_lv_mem_buf_get(sizeof(lv_draw_mask_angle_param_t));
                ...
                lv_draw_mask_radius_param_t * p_ori = (lv_draw_mask_radius_param_t *)m->param;
                lv_draw_mask_radius_param_t * p_new = (lv_draw_mask_radius_param_t *)_lv_mem_buf_get(sizeof(lv_draw_mask_radius_param_t));
                ...
                lv_draw_mask_fade_param_t * p_ori = (lv_draw_mask_fade_param_t *)m->param;
                lv_draw_mask_fade_param_t * p_new = (lv_draw_mask_fade_param_t *)_lv_mem_buf_get(sizeof(lv_draw_mask_fade_param_t));
                ...
                lv_draw_mask_map_param_t * p_ori = (lv_draw_mask_map_param_t *)m->param;
                lv_draw_mask_map_param_t * p_new = (lv_draw_mask_map_param_t *)_lv_mem_buf_get(sizeof(lv_draw_mask_map_param_t));
...
static lv_res_t lv_objmask_signal(lv_obj_t * objmask, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_CLEANUP) {
        ...
        for (i = (lv_objmask_mask_t *)_lv_ll_get_head(&ext->mask_ll); i != NULL; i = (lv_objmask_mask_t *)_lv_ll_get_next(&ext->mask_ll, i)) {
            if(i->param) {
                lv_mem_free(i->param);
                i->param = NULL;
            }
