...
lv_obj_t * lv_linemeter_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_linemeter_ext_t * ext = (lv_linemeter_ext_t *)lv_obj_allocate_ext_attr(linemeter, sizeof(lv_linemeter_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
    ...
    /*Copy an existing line meter*/
        ...
        lv_linemeter_ext_t * copy_ext = (lv_linemeter_ext_t *)lv_obj_get_ext_attr(copy);
...
void lv_linemeter_set_value(lv_obj_t * lmeter, int32_t value)
{
    ...
    lv_linemeter_ext_t * ext = (lv_linemeter_ext_t *)lv_obj_get_ext_attr(lmeter);
