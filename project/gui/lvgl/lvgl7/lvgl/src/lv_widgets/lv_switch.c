...
lv_obj_t * lv_switch_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_switch_ext_t * ext = (lv_switch_ext_t *)lv_obj_allocate_ext_attr(sw, sizeof(lv_switch_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
        lv_obj_del(sw);
        return NULL;
    ...
    /*Copy an existing switch*/
        ...
        lv_switch_ext_t * copy_ext = (lv_switch_ext_t *)lv_obj_get_ext_attr(copy);
