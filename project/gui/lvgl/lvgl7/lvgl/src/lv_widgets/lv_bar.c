...
lv_obj_t * lv_bar_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_bar_ext_t * ext = (lv_bar_ext_t *)lv_obj_allocate_ext_attr(bar, sizeof(lv_bar_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
        lv_obj_del(bar);
        return NULL;
    ...
    if(copy == NULL) {
        ...
        lv_bar_ext_t * ext_copy = (lv_bar_ext_t *)lv_obj_get_ext_attr(copy);
...
void lv_bar_set_value(lv_obj_t * bar, int16_t value, lv_anim_enable_t anim)
{
    ...
    lv_bar_ext_t * ext = (lv_bar_ext_t *)lv_obj_get_ext_attr(bar);
...
static void lv_bar_anim_ready(lv_anim_t * a)
{
    lv_bar_anim_t * var = (lv_bar_anim_t *)a->var;
    lv_bar_ext_t * ext = (lv_bar_ext_t *)lv_obj_get_ext_attr(var->bar);
