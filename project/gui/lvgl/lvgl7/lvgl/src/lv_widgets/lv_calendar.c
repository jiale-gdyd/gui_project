...
lv_obj_t * lv_calendar_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_calendar_ext_t * ext = (lv_calendar_ext_t *)lv_obj_allocate_ext_attr(calendar, sizeof(lv_calendar_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
        lv_obj_del(calendar);
        return NULL;
    ...
    /*Copy an existing calendar*/
        ...
        lv_calendar_ext_t * copy_ext = (lv_calendar_ext_t *)lv_obj_get_ext_attr(copy);
...
void lv_calendar_set_today_date(lv_obj_t * calendar, lv_calendar_date_t * today)
{
    ...
    lv_calendar_ext_t * ext = (lv_calendar_ext_t *)lv_obj_get_ext_attr(calendar);
