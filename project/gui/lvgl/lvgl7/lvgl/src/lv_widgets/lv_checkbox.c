...
lv_obj_t * lv_checkbox_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_checkbox_ext_t * ext = (lv_checkbox_ext_t *)lv_obj_allocate_ext_attr(cb, sizeof(lv_checkbox_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
        lv_obj_del(cb);
        return NULL;
    ...
    if(copy == NULL) {
        ...
        lv_checkbox_ext_t * copy_ext = (lv_checkbox_ext_t *)lv_obj_get_ext_attr(copy);
...
void lv_checkbox_set_text(lv_obj_t * cb, const char * txt)
{
    ...
    lv_checkbox_ext_t * ext = (lv_checkbox_ext_t *)lv_obj_get_ext_attr(cb);
