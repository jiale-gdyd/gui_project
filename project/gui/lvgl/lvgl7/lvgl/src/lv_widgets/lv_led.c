...
lv_obj_t * lv_led_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_led_ext_t * ext = (lv_led_ext_t *)lv_obj_allocate_ext_attr(led, sizeof(lv_led_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
        lv_obj_del(led);
        return NULL;
    ...
    /*Copy an existing object*/
        ...
        lv_led_ext_t * copy_ext = (lv_led_ext_t *)lv_obj_get_ext_attr(copy);
...
void lv_led_set_bright(lv_obj_t * led, uint8_t bright)
{
    ...
    /*Set the brightness*/
    lv_led_ext_t * ext = (lv_led_ext_t *)lv_obj_get_ext_attr(led);
