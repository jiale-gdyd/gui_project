...
lv_obj_t * lv_slider_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_slider_ext_t * ext = (lv_slider_ext_t *)lv_obj_allocate_ext_attr(slider, sizeof(lv_slider_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
        lv_obj_del(slider);
        return NULL;
    ...
    /*Copy an existing slider*/
        ...
        lv_slider_ext_t * copy_ext = (lv_slider_ext_t *)lv_obj_get_ext_attr(copy);
...
bool lv_slider_is_dragged(const lv_obj_t * slider)
{
    ...
    lv_slider_ext_t * ext = (lv_slider_ext_t *)lv_obj_get_ext_attr(slider);
...
static lv_res_t lv_slider_signal(lv_obj_t * slider, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_PRESSED) {
        ...
        if(lv_indev_get_type((const lv_indev_t *)param) != LV_INDEV_TYPE_POINTER) return res;
        ...
        lv_group_t * g             = (lv_group_t *)lv_obj_get_group(slider);
        ...
        if(lv_obj_get_width(slider) != lv_area_get_width((const lv_area_t *)param) ||
           lv_obj_get_height(slider) != lv_area_get_height((const lv_area_t *)param)) {
