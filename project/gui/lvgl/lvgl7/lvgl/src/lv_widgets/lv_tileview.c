...
lv_obj_t * lv_tileview_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_tileview_ext_t * ext = (lv_tileview_ext_t *)lv_obj_allocate_ext_attr(new_tileview, sizeof(lv_tileview_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
    ...
    /*Copy an existing tileview*/
        ...
        lv_tileview_ext_t * copy_ext = (lv_tileview_ext_t *)lv_obj_get_ext_attr(copy);
