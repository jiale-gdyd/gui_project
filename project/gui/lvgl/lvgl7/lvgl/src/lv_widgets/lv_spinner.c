...
lv_obj_t * lv_spinner_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    lv_spinner_ext_t * ext = (lv_spinner_ext_t *)lv_obj_allocate_ext_attr(spinner, sizeof(lv_spinner_ext_t));
    LV_ASSERT_MEM(ext);
    if(ext == NULL) {
        lv_obj_del(spinner);
        return NULL;
    ...
    /*Copy an existing spinner*/
        ...
        lv_spinner_ext_t * copy_ext = (lv_spinner_ext_t *)lv_obj_get_ext_attr(copy);
...
void lv_spinner_set_arc_length(lv_obj_t * spinner, lv_anim_value_t deg)
{
    ...
    lv_spinner_ext_t * ext = (lv_spinner_ext_t *)lv_obj_get_ext_attr(spinner);
