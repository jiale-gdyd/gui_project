...
void lv_img_cache_set_size(uint16_t new_entry_cnt)
{
    ...
    LV_GC_ROOT(_lv_img_cache_array) = (lv_img_cache_entry_t *)lv_mem_alloc(sizeof(lv_img_cache_entry_t) * new_entry_cnt);
...
static bool lv_img_cache_match(const void * src1, const void * src2)
{
    ...
    if(lv_img_src_get_type(src2) != LV_IMG_SRC_FILE)
        return false;
    return strcmp((const char *)src1, (const char *)src2) == 0;
}
#endif
