...
lv_obj_t * lv_gif_create_from_file(lv_obj_t * parent, const char * path)
{
    ...
    lv_gif_ext_t * ext = (lv_gif_ext_t *)lv_obj_allocate_ext_attr(img, sizeof(lv_gif_ext_t));
    LV_ASSERT_MEM(ext);
...
{
    lv_gif_ext_t * ext = (lv_gif_ext_t *)lv_obj_get_ext_attr(gif);
...
static void next_frame_task_cb(lv_task_t * t)
{
    ...
    lv_gif_ext_t * ext = (lv_gif_ext_t *)lv_obj_get_ext_attr(img);
