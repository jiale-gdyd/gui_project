...
UINT                         status;
    ...
    if (timer_thread_input == TX_TIMER_ID)
    {
        ...
        while (TX_LOOP_FOREVER)
        {
            ...
            *_tx_timer_current_ptr =  (TX_TIMER_INTERNAL*)TX_NULL;
            ...
            while (expired_timers != TX_NULL)
            {
                ...
                reactivate_timer =  (TX_TIMER_INTERNAL*)TX_NULL;
                ...
                if (current_timer == next_timer)
                {
                    ...
                    expired_timers =  (TX_TIMER_INTERNAL*)TX_NULL;
                ...
                if (current_timer -> tx_timer_internal_remaining_ticks > TX_TIMER_ENTRIES)
                {
                    ...
                    /* Set the timeout function to NULL in order to bypass the
                       expiration.  */
                    timeout_function =  (VOID (*)(ULONG))TX_NULL;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        current_timer -> tx_timer_internal_list_head =  (struct TX_TIMER_INTERNAL_STRUCT **)TX_NULL;
                    }
                }
                ...
                _tx_timer_expired_timer_ptr =  (TX_TIMER_INTERNAL*)TX_NULL;
