    ...
    else
    {
        ...
        if (group_ptr -> tx_event_flags_group_suspension_list != TX_NULL)
        {
            ...
            if (suspended_count == ((UINT) 1))
            {
                ...
                if (flags_satisfied != ((ULONG) 0))
                {
                    ...
                    *suspend_info_ptr =  current_event_flags;
                    ...
                    group_ptr -> tx_event_flags_group_suspension_list =  (struct TX_THREAD_STRUCT *)TX_NULL;
            ...
            else
            {
                ...
                satisfied_list = (TX_THREAD *)TX_NULL;
                last_satisfied = (TX_THREAD *)TX_NULL;
                ...
                do
                {
                    ...
                    if (flags_satisfied != ((ULONG) 0))
                    {
                        ...
                        if (thread_ptr == thread_ptr -> tx_thread_suspended_next)
                        {
                            ...
                            suspended_list = (TX_THREAD *)TX_NULL;
                        }
                        else
                        {
                        ...
                        if (satisfied_list == TX_NULL)
                        {
                            ...
                            thread_ptr -> tx_thread_suspended_next = (struct TX_THREAD_STRUCT *)TX_NULL;
                        }
                        else
                        {
