            ...
            else
            {
                ...
                else
                {
                    ...
                    if (thread_ptr -> tx_thread_owned_mutex_count == ((UINT) 0))
                    {
                        ...
                        thread_ptr -> tx_thread_owned_mutex_list =  (struct TX_MUTEX_STRUCT *)TX_NULL;
                    }
                    else
                    {
                    ...
                    if (mutex_ptr -> tx_mutex_suspension_list == TX_NULL)
                    {
                        ...
                        if (mutex_ptr -> tx_mutex_inherit == TX_FALSE)
                        {
                            ...
                            mutex_ptr -> tx_mutex_owner =  (TX_THREAD *)TX_NULL;
                    ...
                    if (status == TX_NOT_DONE)
                    {
                        ...
                        else
                        {
                            ...
                            if (suspended_count == TX_NO_SUSPENSIONS)
                            {
                                ...
                                mutex_ptr -> tx_mutex_suspension_list =  (struct TX_THREAD_STRUCT *)TX_NULL;
                            }
                            else
                            {
