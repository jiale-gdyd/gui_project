...
UINT                        processing_complete;
    ...
    if ((thread_ptr -> tx_thread_suspending) == TX_TRUE)
    {
        ...
        if (thread_ptr == _tx_thread_preemption__threshold_scheduled)
        {
            ...
            _tx_thread_preemption_threshold_list[thread_ptr -> tx_thread_priority] =  (TX_THREAD*)TX_NULL;
        ...
        if (priority_map == ((ULONG) 0))
        {
            ...
            _tx_thread_execute_ptr[i] =  (TX_THREAD*)TX_NULL;
