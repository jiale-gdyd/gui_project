...
VOID  _tx_thread_initialize(VOID)
{
    ...
    _tx_thread_created_ptr =        (TX_THREAD*)TX_NULL;
    ...
    _tx_thread_mutex_release = (VOID (*)(TX_THREAD *))TX_NULL;

#ifdef TX_ENABLE_STACK_CHECKING

    /* Clear application registered stack error handler.  */
    _tx_thread_application_stack_error_handler =  (VOID (*)(TX_THREAD *))TX_NULL;
#endif
