    ...
    if ((thread_ptr -> tx_thread_timer.tx_timer_internal_list_head) != TX_NULL)
    {
        ...
        if (timer_ptr == next_timer)
        {
            ...
            if (*(list_head) == timer_ptr)
            {
                ...
                *(list_head) =  (TX_TIMER_INTERNAL*)TX_NULL;
            }
        }
        else
        {
        ...
        timer_ptr -> tx_timer_internal_list_head =  (struct TX_TIMER_INTERNAL_STRUCT **)TX_NULL;
    }
    else
    {
                                            ...
                                            else
                                            {
                                                ...
                                                while (possible_preemption_list[i] != TX_NULL)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        _tx_thread_execute_ptr[j] =  (TX_THREAD*)TX_NULL;
