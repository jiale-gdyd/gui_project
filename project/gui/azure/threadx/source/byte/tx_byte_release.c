                ...
                if (susp_thread_ptr ==  pool_ptr -> tx_byte_pool_suspension_list)
                {
                    ...
                    if (susp_thread_ptr -> tx_thread_suspend_info == memory_size)
                    {
                        ...
                        if (suspended_count == TX_NO_SUSPENSIONS)
                        {
                            ...
                            pool_ptr -> tx_byte_pool_suspension_list =  (struct TX_THREAD_STRUCT *)TX_NULL;
                        }
                        else
                        {
                        ...
                        susp_thread_ptr -> tx_thread_suspend_cleanup = (VOID (*)(struct TX_THREAD_STRUCT *, ULONG))TX_NULL;
