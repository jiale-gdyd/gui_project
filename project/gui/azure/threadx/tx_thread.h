...
UINT    i;
    ...
    _tx_thread_smp_schedule_list[0] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 1
    _tx_thread_smp_schedule_list[1] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 2
    _tx_thread_smp_schedule_list[2] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 3
    _tx_thread_smp_schedule_list[3] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 4
    _tx_thread_smp_schedule_list[4] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 5
    _tx_thread_smp_schedule_list[5] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 6
...
UINT    j;
    ...
    _tx_thread_execute_ptr[0] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 1
    _tx_thread_execute_ptr[1] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 2
    _tx_thread_execute_ptr[2] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 3
    _tx_thread_execute_ptr[3] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 4
    _tx_thread_execute_ptr[4] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 5
    _tx_thread_execute_ptr[5] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 6
...
ULONG       possible_cores =  ((ULONG) 0);
    ...
    possible_preemption_list[0] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 1
    possible_preemption_list[1] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 2
    possible_preemption_list[2] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 3
    possible_preemption_list[3] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 4
    possible_preemption_list[4] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 5
    possible_preemption_list[5] =  (TX_THREAD *)TX_NULL;
#if TX_THREAD_SMP_MAX_CORES > 6
...
UINT            map_index;
    ...
    else
    {
        ...
        /* This is the only thread at this priority ready to run.  Set the head
           pointer to NULL.  */
        _tx_thread_priority_list[priority] =    (TX_THREAD *)TX_NULL;
