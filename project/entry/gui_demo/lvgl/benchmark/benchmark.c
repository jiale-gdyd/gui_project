...
{
    lv_style_reset(&style_common);
    lv_style_set_image_opa(&style_common, scene_with_opa ? LV_OPA_50 : LV_OPA_COVER);
...
static void img_rgb_recolor_cb(void)
{
    lv_style_reset(&style_common);
    lv_style_set_image_opa(&style_common, scene_with_opa ? LV_OPA_50 : LV_OPA_COVER);
    lv_style_set_image_recolor_opa(&style_common, LV_OPA_50);
    img_create(&style_common, &img_benchmark_cogwheel_rgb, false, false, false);
}
...
static scene_dsc_t scenes[] = {
    ...
    {.name = "Image RGB rotate",               .create_cb = img_rgb_rot_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 5},
    {.name = "Image RGB rotate anti aliased",  .create_cb = img_rgb_rot_aa_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 10},
    {.name = "Image ARGB rotate",              .create_cb = img_argb_rot_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 10},
    {.name = "Image ARGB rotate anti aliased", .create_cb = img_argb_rot_aa_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 15},
    {.name = "Image RGB zoom",                 .create_cb = img_rgb_zoom_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 5},
    {.name = "Image RGB zoom anti aliased",    .create_cb = img_rgb_zoom_aa_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 10},
    {.name = "Image ARGB zoom",                .create_cb = img_argb_zoom_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 10},
    {.name = "Image ARGB zoom anti aliased",   .create_cb = img_argb_zoom_aa_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 15},
    ...
    {.name = "Substr. image",                  .create_cb = sub_image_cb, .time_sum_normal = 0, .time_sum_opa = 0, .refr_cnt_normal = 0, .refr_cnt_opa = 0, .fps_normal = 0, .fps_opa = 0, .weight = 10},
...
static void show_scene_report(void)
{
    ...
    if (scene_with_opa) {
        lv_label_set_text_fmt(subtitle, "Result: %" LV_PRIu32 " FPS", scenes[scene_act].fps_opa);
        LV_LOG("Result of \"%s + opa\": %" LV_PRIu32 " FPS\n", scenes[scene_act].name, scenes[scene_act].fps_opa);
    } else {
        lv_label_set_text_fmt(subtitle, "Result: %" LV_PRIu32 " FPS", scenes[scene_act].fps_normal);
...
static void img_create(lv_style_t *style, const void *src, bool rotate, bool zoom, bool aa)
{
    ...
    for (i = 0; i < (uint32_t)IMG_NUM; i++) {
        lv_obj_t *obj = lv_image_create(scene_bg);
        lv_obj_remove_style_all(obj);
        lv_obj_add_style(obj, style, 0);
        ...
        if (zoom) {
            lv_image_set_zoom(obj, rnd_next(IMG_ZOOM_MIN, IMG_ZOOM_MAX));
        }
