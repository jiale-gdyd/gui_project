...
int azure_guix_thermostat_demo_init(int argc, char *argv[])
{
#if defined(CONFIG_DRM_DISP_DRIVER)
    gx_drm_graphics_driver_setup(1, MAIN_DISPLAY_X_RESOLUTION, MAIN_DISPLAY_Y_RESOLUTION, 0, 0, DISP_IMAGE_TYPE_RGB565, DISP_PLANE_OVERLAY, 1);
#endif
...
int azure_guix_thermostat_demo_exit(void)
{
...
GX_STRING string;
    ...
    string.gx_string_length = GX_STRLEN(str_value)/*sizeof(str_value) - 1*/;
