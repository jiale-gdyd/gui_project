#ifndef _GUIX_KEYBOARD_SPECIFICATIONS_H_
#define _GUIX_KEYBOARD_SPECIFICATIONS_H_
...
#define ID_INPUT_FIELD 1
#define IDB_BACKSPACE 2
...
typedef struct KEYBOARD_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PIXELMAP_BUTTON keyboard_screen_pixelmap_button_1;
    GX_WINDOW keyboard_screen_keyboard_frame;
    GX_ICON keyboard_screen_icon_1;
