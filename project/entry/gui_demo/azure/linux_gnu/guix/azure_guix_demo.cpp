...
int azure_linux_gnu_guix_demo_init(int argc, char *argv[])
{
    ...
    return azure_linux_gnu_guix_calculator_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_WIDGET_TYPES)
    return azure_linux_gnu_guix_widget_types_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_WASHING_MACHINE)
    return azure_linux_gnu_guix_washing_machine_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_THERMOSTAT)
    return azure_linux_gnu_guix_thermostat_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_SPRITE)
    return azure_linux_gnu_guix_sprite_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_SMART_WATCH)
    return azure_linux_gnu_guix_smart_watch_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_SHAPES)
    return azure_linux_gnu_guix_shapes_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_MEDICAL)
    return azure_linux_gnu_guix_medical_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_KEYBOARD)
    return azure_linux_gnu_guix_keyboard_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_HOME_AUTOMATION)
    return azure_linux_gnu_guix_home_automation_demo_init(argc, argv);
#elif defined(CONFIG_AZURE_GUIX_CAR_INFOTAINMENT)
    return azure_linux_gnu_guix_car_infotainment_demo_init(argc, argv);
#endif
...
#elif defined(CONFIG_AZURE_GUIX_CALCULATOR)
    return azure_linux_gnu_guix_calculator_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_WIDGET_TYPES)
    return azure_linux_gnu_guix_widget_types_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_WASHING_MACHINE)
    return azure_linux_gnu_guix_washing_machine_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_THERMOSTAT)
    return azure_linux_gnu_guix_thermostat_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_SPRITE)
    return azure_linux_gnu_guix_sprite_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_SMART_WATCH)
    return azure_linux_gnu_guix_smart_watch_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_SHAPES)
    return azure_linux_gnu_guix_shapes_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_MEDICAL)
    return azure_linux_gnu_guix_medical_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_KEYBOARD)
    return azure_linux_gnu_guix_keyboard_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_HOME_AUTOMATION)
    return azure_linux_gnu_guix_home_automation_demo_exit();
#elif defined(CONFIG_AZURE_GUIX_CAR_INFOTAINMENT)
    return azure_linux_gnu_guix_car_infotainment_demo_exit();
#endif
